...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $queryValid = mysqli_query($con, "UPDATE pengaduan SET status = 'proses' WHERE id_pengaduan = '$id';");
...
<div class="card">
    <h5 class="card-header">Pengaduan Valid</h5>
                ...
                foreach ($getData as $data) {
                    ...
                    echo "
                        <tr>
                            ...
                            <td>$status</td>
                            <td>
                                <a href='./tanggapan_valid.php?id=$data[id_pengaduan]' class='btn btn-danger'>
                                    Tanggapi
                                </a>
                            </td>
                            <td>
